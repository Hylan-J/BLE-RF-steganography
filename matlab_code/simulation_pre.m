...
load('preamble_tx.mat');
load('message_fec_encoded_tx.mat');

message_m = transpose(message_fec_encoded_tx);
data_complex_m = preamble_tx;
% 
...
for i = 1:num_pkts
    ...
    message_transmit = bit2int([message_bit';0], 8);
    ...
    preamble_stega = repmat(data_complex_m(i,:), 1, loraphy.preamble_len);
    % preamble_stega = repmat(data_complex_m(i,:), 1, 3);
